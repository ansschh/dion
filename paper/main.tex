...
\begin{figure}[H]
    ...
    \caption{Hyperparameter sweep results (24 configurations, 5k steps each). Clear pattern: lr=0.005 with high rank\_frac/alpha is optimal for both Dion and Dion2.}
    \label{fig:sweep}
\end{figure}
